...
#identify all of the interfaces on the system that this script will parse through
IntArray=($(ip route | grep -w "default" | awk '{print $5}'))



#parse through the interfaces on the system using the array created above
